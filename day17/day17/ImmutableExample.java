...
final class MutableIDCard {
    ...
    final private BufferedImage photo;

    public MutableIDCard(String name,Date dateOfBirth,BufferedImage photo) {
        String nameCopy = name.copy();
        Date dateOfBirthCopy = dateOfBirth.copy();
        BufferedImage photoCopy = photo.copy();
    }
    ...
    private long getAge(Date dateOfBirth) {
        ...
        long age = now - this.getDateOfBirth().getTime();
        return age;
    }
}
...
class Officer implements Runnable {
    ...
    public void run() {
        ...
        Date dateOfBirth = DataGenerator.getNextDate();
        BufferedImage photo = DataGenerator.getNextPhoto();
        this.id = new MutableIDCard(name, dateOfBirth, photo);
    }
}
