...
two = Math.floor(change / 2)
change = change - (two * 2)
one = Math.floor(change / 1) 
change = change - (one * 1)
fiftyp = Math.floor(change / 0.5
change = change - (fiftyp * 0.5)
twentyp = Math.floor(change / 0.2 
change = change - (twentyp * 0.2)
tenp = Math.floor(change / 0.1)
change = change - (tenp * 0.1)
fivep = Math.floor(change / 0.05) 
change = change - (fivep * 0.05)
twop = Math.floor(change / 0.02) 
change = change - (twop * 0.02)
onep = Math.floor(change / 0.01)
